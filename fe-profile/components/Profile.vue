<template>
  <div class="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      <div
        class="bg-white rounded-lg shadow-lg p-8 mb-4 text-center text-4xl font-bold"
      >
      ...
      <div class="bg-white rounded-lg shadow-lg p-8">
        <div class="flex items-center space-x-6">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Nico</h1>
            <p class="text-gray-600 mt-1">Developer</p>
            <p class="text-gray-500 mt-2">Surabaya</p>
          </div>
        </div>
        <div class="mt-6 border-t border-gray-200 pt-6">
          <h2 class="text-xl font-semibold text-gray-900">About Me</h2>
          <p class="mt-2 text-gray-600 leading-relaxed">
           Yes im, i am a web developer
          </p>
        </div>
      </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              <p class="text-gray-900">
                Created new project "Kampus Gratis"
              </p>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="border rounded-lg p-4">
            ...
            <p class="mt-2 text-gray-600">
              A web application for learning and education for free.
            </p>
